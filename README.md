...
<p align="center">
    ...
    <h3 align="center"><a href="https://learnwithsumit.com/courses/think-in-a-redux-way/filters-and-search-feature-2">Assignment 6 - Add features to Video website
</a></h3>
</p>
...
2. Clone this repository -
    ```sh
    git clone https://github.com/Learn-with-Sumit/assignment-6---add-features-to-video-website-programmertowheed.git
    ```
3. Go to the cloned project directory
    ```sh
    cd assignment-6---add-features-to-video-website-programmertowheed
    ```
